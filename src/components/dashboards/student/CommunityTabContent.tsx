                  ...
                  <div className="p-5 border-t border-slate-100 bg-slate-50/50 space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                      ...
                      <button
                        ...
                        className={`px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 ${isSelectedPrivate ? "bg-purple-600 hover:bg-purple-700 shadow-purple-600/20" : "bg-blue-600 hover:bg-blue-700 shadow-blue-600/20"
                          }`}
                      >
                        {isJoining ? (
                          <>
