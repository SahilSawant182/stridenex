...
interface DashboardDynamicFormProps {
  fields: DynamicField[];
...
export function DashboardDynamicForm({
  fields,
  initialValues = {},
  onSubmit,
  loading = false,
  ...
  return (
    <div className={`bg-white rounded-2xl w-full ${maxWidth} flex flex-col`}>
      {/* Form Content */}
      ...
      {/* Footer */}
      {!hideFooter && (
        <div className="pt-6 mt-4 border-t border-slate-100 flex items-center justify-end gap-4">
          <Button
            type="button"
