...
const tabConfig = {
  ...
  college: [
    ...
    { name: "Students", path: "/college/dashboard/students", icon: GraduationCap },
    { name: "Placements", path: "/college/dashboard/placements", icon: TrendingUp },
    { name: "NEP & UGC 2026", path: "/college/dashboard/nepUgc", icon: Users },
    { name: "Interventions", path: "/college/dashboard/interventions", icon: Building2 },
    { name: "Notice Board", path: "/college/dashboard/noticeBoard", icon: BarChart },
    { name: "Reports", path: "/college/dashboard/reports", icon: Calendar },
    { name: "Subscriptions", path: "/college/dashboard/subscriptions", icon: Award },
  ],
  mentor: [
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              key={tab.path}
              href={tab.path}
              className={`relative flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors ${isActive
