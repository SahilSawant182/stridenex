    ...
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         ...
         <motion.div variants={itemVariants}>
           <BaseCard className="p-8 border-slate-200 shadow-sm h-full flex flex-col bg-slate-50/50">
              <div>
                ...
                <div className="flex items-baseline gap-1 mt-2 mb-8">
                  <span className="text-3xl font-black text-slate-600">₹4,999</span>
         ...
         <motion.div variants={itemVariants}>
           <div className="relative h-full">
               <BaseCard className="p-8 border-orange-500 shadow-sm h-full flex flex-col bg-white ring-1 ring-orange-500/30">
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-1 mt-2 mb-8">
                      <span className="text-3xl font-black text-orange-500">₹14,999</span>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-700 font-semibold">
                {billingHistory.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-5 py-4 text-xs font-semibold">{item.date}</td>
                    <td className="px-5 py-4 text-xs font-medium">{item.desc}</td>
                    <td className="px-5 py-4 text-xs font-bold">{item.amount}</td>
                    ...
                    <td className="px-5 py-4">
                      <button className="text-[10px] font-bold uppercase tracking-wider border border-slate-200 text-slate-500 hover:text-slate-800 hover:border-slate-300 py-1 px-3 rounded bg-white transition-colors">
                        PDF
                      </button>
                    </td>
                  </tr>
