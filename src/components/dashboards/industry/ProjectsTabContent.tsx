...
export default function ProjectsTabContent() {
  ...
  const projectFields: IndustryField[] = useMemo(() => [
    { name: "project_name", label: "Project Name", type: "text", icon: Briefcase, required: true, colSpan: 2, placeholder: "e.g. AI Resume Screening System" },
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      <IndustryDynamicModal
        ...
        subtitle="Shared with all registered colleges"
        headerIcon={Briefcase}
        iconBgColor="bg-orange-500"
        fields={projectFields}
        initialValues={{ industry: companyName || "Razorpay Technologies", status: "Active" }}
