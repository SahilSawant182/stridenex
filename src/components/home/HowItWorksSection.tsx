...
const steps = [
    {
        ...
        description: "Follow guided pathways aligned with real industry expectations instead of random course selection. Build a solid foundation with interactive modules and targeted learning objectives designed to bridge the gap between academic curriculum and market demands.",
        icon: Lightbulb,
    ...
    },
    {
        ...
        description: "Work on practical assignments and collaborative projects supported by mentors and experts. Translate your theoretical knowledge into demonstrated capabilities through hands-on execution and iterative feedback loops.",
        icon: Users,
    ...
    },
    {
        ...
        description: "Showcase verified skills through dynamic profiles trusted by recruiters and institutions. Confidently step into the professional world with proven credentials, direct recruiter visibility, and seamless career transition support.",
        icon: TrendingUp,
