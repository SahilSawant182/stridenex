...
export default function StrategicShift() {
  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-50/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-indigo-50/50 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto relative">
          ...
          {shifts.map((shift, index) => (
            <motion.div
              ...
              className={`p-10 rounded-3xl bg-white border ${shift.borderColor} shadow-xl shadow-gray-200/20 relative overflow-hidden group`}
            >
              ...
              <div className="relative z-10">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 bg-white shadow-sm border border-gray-50 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <motion.div 
          ...
          className="mt-24 bg-white/60 backdrop-blur-xl rounded-3xl p-10 max-w-5xl mx-auto border border-white shadow-2xl shadow-blue-900/5"
        >
